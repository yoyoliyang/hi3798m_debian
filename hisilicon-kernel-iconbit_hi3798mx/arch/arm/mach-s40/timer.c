...
static struct hi_timer_t hi_timer[] = {
	...
	HI_TIMER(8, INTNR_TIMER_A_B, REG_BASE_TIMERAB),
	HI_TIMER(9, INTNR_TIMER_A_B, REG_BASE_TIMERAB + 0x20),
	HI_TIMER(10, INTNR_TIMER_C_D, REG_BASE_TIMERCD),
	HI_TIMER(11, INTNR_TIMER_C_D, REG_BASE_TIMERCD + 0x20),
};
