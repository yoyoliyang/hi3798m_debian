...
static void sha1( const unsigned char *input, int ilen, unsigned char output[20] )
{
    ...
    hi_sha1_starts( &ctx );
    hi_sha1_update( &ctx, input, ilen );
    hi_sha1_finish( &ctx, output );
...
void sha1_hmac_starts( sha1_context *ctx, const unsigned char *key, int keylen )
{
    ...
    hi_sha1_starts( ctx );
    hi_sha1_update( ctx, ctx->ipad, 64 );
...
void sha1_hmac_finish( sha1_context *ctx, unsigned char output[20] )
{
    ...
    hi_sha1_finish( ctx, tmpbuf );
    hi_sha1_starts( ctx );
    hi_sha1_update( ctx, ctx->opad, 64 );
    hi_sha1_update( ctx, tmpbuf, 20 );
    hi_sha1_finish( ctx, output );
