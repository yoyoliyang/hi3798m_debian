...
static const struct dev_pm_ops hiusb_ohci_pmops = {
	...
	.freeze = hiusb_ohci_hcd_drv_suspend,
	.thaw = hiusb_ohci_hcd_drv_resume,
	.poweroff = hiusb_ohci_hcd_drv_suspend,
	.restore = hiusb_ohci_hcd_drv_resume,
#endif
};
...
static struct resource hiusb_ohci1_res[] = {
	[0] = {
		.start = CONFIG_HIUSB_OHCI1_IOBASE,
		.end   = CONFIG_HIUSB_OHCI1_IOBASE +
				 CONFIG_HIUSB_OHCI1_IOSIZE - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = CONFIG_HIUSB_OHCI1_IRQNUM,
		.end   = CONFIG_HIUSB_OHCI1_IRQNUM,
		.flags = IORESOURCE_IRQ,
	},
};

static struct platform_device hiusb_ohci1_platdev = {
	.name   = "hiusb-ohci",
	.id     = 1,
	.dev    = {
		.platform_data  = NULL,
	...
	.num_resources = ARRAY_SIZE(hiusb_ohci1_res),
	.resource       = hiusb_ohci1_res,
};
#endif
